...
<a href="acercade.php"><i class="icon-bubbles4"></i> Acerca de</a>
 ...
 <center>
  <form action="hcitasdocho.php" method="post">
   <?php if (isset($_GET['notuser']) == "null") {
    echo "<h3 class='archivo'>El codigo doctor no existe.</h3> <br/>";
   }
   ...
   <input type="text" name="codigodoc" required placeholder="COD. DOCTOR" class="form-input" autocomplete="off"><br><br>
