...
<head>
 ...
 <link rel="stylesheet" type="text/css" href="../css/hcitasenfe.css">
</head>
...
<body>
 ...
 <center>
  <form action="hcitasenfeho.php" method="post">
   <?php
   if (isset($_GET['notuser']) == "null") {
    echo "<h3 class='archivo'>El codigo de Enfermeria no existe.</h3> <br/>";
   }
   if (isset($_GET['notpa']) == "off") {
    echo "<h3 class='archivo'>El paciente no esta Archivado.<br> <a href='arpaci.php'>Archivar Paciente</a></h3><br/>";
   } ?>
   ...
   <input type="text" name="codigoenfe" required placeholder="COD. ENFERMERA" autocomplete="off" class="form-input"><br><br>
