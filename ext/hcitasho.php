...
try
{
	...
	$revpafil = mysqli_num_rows($revpares); if ($revpafil>0) { } else  { header("Location: hcitas.php?notpa=off"); }
	$conn ->next_result();
...
<center>
<form action="hcitasres.php" method="post">
...
<?php
	...
	<a href="hcitas.php"><input type="button" value="Atras" class="volver"></a>
